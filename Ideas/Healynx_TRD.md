...
| **Responsive Strategy** | Tailwind CSS + Radix UI primitives + shadcn/ui | Tailwind 3.x, Radix latest, shadcn/ui latest | Mobile-first utility CSS ensures 320px–1920px responsiveness per NFR-06. Radix UI provides accessible, unstyled primitives for modals, dropdowns, and accordions that meet WCAG 2.1 AA. shadcn/ui adds pre-styled, composable components built on Radix + Tailwind, accelerating UI development while keeping bundle optimised. |
